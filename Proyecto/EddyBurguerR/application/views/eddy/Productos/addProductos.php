  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          <form class="" name="form" role="form" data-toggle="validator" action="saveProductos" data-parsley-validate method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="clearfix"></div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="nombre" value="" class="form-control col-md-7 col-xs-12" required="required">
              </div>
            </div>
...
<div class="clearfix"></div>
            <div class="form-group">
              ...
              <div class="clearfix"></div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="stock" value="" class="form-control col-md-7 col-xs-12" required="required">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="clearfix"></div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="precio" value="" class="form-control col-md-7 col-xs-12" required="required">
              </div>
            </div>
