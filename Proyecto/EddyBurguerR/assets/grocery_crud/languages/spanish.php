<?php
	...
	$lang['alert_delete_multiple'] = '¿Estás seguro de eliminar estos {items_amount} elementos?';

	$lang['alert_delete_multiple_one'] = 'Estás seguro de eliminar este 1 elemento?';
