...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2">
            ...
            <input type="button" value="<?php echo $this->l('list_search');?>" class="crud_color_search crud_search" id='crud_search'>
		</div>
        <div class='search-div-clear-button'>
        	<input type="button" value="<?php echo $this->l('list_clear_filtering');?>" id='search_clear' class="search_color_clear search_clear">
        </div>
	</div>
	<div class="pDiv">
		<div class="pDiv2">
